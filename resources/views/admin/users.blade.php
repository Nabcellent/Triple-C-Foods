                                ...
                                <div class="bg-white shadow-md rounded my-6">
                                    <table class="min-w-max w-full table-auto">
                                        ...
                                        <tr class="border-b border-gray-200 hover:bg-gray-100">
                                            ...
                                            <td class="py-3 px-6 text-center">
                                                <span class="bg-purple-200 text-purple-600 py-1 px-3 rounded-full text-xs">Inactive</span>
                                            </td>
                                            <td class="py-3 px-6 text-center">
                                        ...
                                        <tr class="border-b border-gray-200 bg-gray-50 hover:bg-gray-100">
                                            ...
                                            <td class="py-3 px-6 text-left">ann@gmail.com</td>
                                            <td class="py-3 px-6 text-center">
                                                <div class="flex items-center justify-center">Female</div>
                                            </td>
                                            <td class="py-3 px-6 text-center">
                                                <span class="bg-green-200 text-green-600 py-1 px-3 rounded-full text-xs">Active</span>
                                            </td>
                                        ...
                                        <tr class="border-b border-gray-200 hover:bg-gray-100">
                                            ...
                                            <td class="py-3 px-6 text-left">james@gmail.com</td>
                                            <td class="py-3 px-6 text-center">
                                                <div class="flex items-center justify-center">Female</div>
                                            </td>
                                            <td class="py-3 px-6 text-center">
